...
```{r}
HestonCallClosedForm(1.77, 0.1, 0.05096, -0.3997, 0.11, 0.0411, 1, 100, 100)
#HestonCallMonteCarlo(2, 0.08, 0.2, -0.5, 0.11, 0.0411, 1, 100, 100, vneg = 0)
```
...
```{r}
params <- simulated_annealing(c(2 * 2 * 0.1 - 0.467514601^2,0.1,0.467514601,-0.50903932))
a <- params[[1]]
theta <- params[[2]]
miu <- params[[3]]
rho <- params[[4]]
